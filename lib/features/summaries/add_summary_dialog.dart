...
class AddSummaryDialog extends ConsumerStatefulWidget {
  const AddSummaryDialog({super.key});

  @override
  ConsumerState<AddSummaryDialog> createState() => _AddSummaryDialogState();
}

class _AddSummaryDialogState extends ConsumerState<AddSummaryDialog> {
  ...
  Future<void> _submit() async {
    ...
    final errorMessage = await ref.read(summaryProvider.notifier).addSummary(
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                // Title
                Text(
                  '${l10n.addContent}: ${l10n.summaries}',
