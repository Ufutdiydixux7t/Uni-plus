...
class AddDailyReportDialog extends ConsumerStatefulWidget {
  const AddDailyReportDialog({super.key});

  @override
  ConsumerState<AddDailyReportDialog> createState() => _AddDailyReportDialogState();
}

class _AddDailyReportDialogState extends ConsumerState<AddDailyReportDialog> {
