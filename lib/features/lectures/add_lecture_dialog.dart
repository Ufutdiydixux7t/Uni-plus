...
class AddLectureDialog extends ConsumerStatefulWidget {
  const AddLectureDialog({super.key});

  @override
  ConsumerState<AddLectureDialog> createState() => _AddLectureDialogState();
}

class _AddLectureDialogState extends ConsumerState<AddLectureDialog> {
